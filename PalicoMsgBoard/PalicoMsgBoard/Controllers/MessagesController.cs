...
namespace PalicoMsgBoard.Controllers
{
    ...
    public class MessagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Text,IsPublic")] Message message)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Text,IsPublic")] Message message)
        {
            if (id != message.Id)
            {
                return NotFound();
